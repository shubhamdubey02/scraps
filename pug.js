...
async function loginToDribbble() {
  const browser = await puppeteer.launch({ headless: true }); // Run in headless mode for scraping
  ...
  await page.type('input[name="login"]', 'ix.ankit9012@gmail.com'); // Replace with your email
  await page.type('input[name="password"]', 'Test@123'); // Replace with your password
